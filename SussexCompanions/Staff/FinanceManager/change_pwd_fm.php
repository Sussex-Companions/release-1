...
$conn=new mysqli('localhost','root','Bals@123','sc_club') or die(mysqli_error());
 if(count($_POST)>0){
  ...
  if (!$result) {
   ...
   if($sql)
        ...
        {
       echo "<script>alert('Your new and Retype Password is not match'); window.location='change_pwd_fm.php'</script>";
       }    
 }
 ?> 
